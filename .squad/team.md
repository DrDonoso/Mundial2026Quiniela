...
|------|------|---------|--------|
| Danny | Lead | `.squad/agents/danny/charter.md` | 🏗️ Active |
| Rusty | Frontend Dev | `.squad/agents/rusty/charter.md` | ⚛️ Active |
| Linus | Backend Dev | `.squad/agents/linus/charter.md` | 🔧 Active |
| Basher | DevOps | `.squad/agents/basher/charter.md` | ⚙️ Active |
| Livingston | Tester | `.squad/agents/livingston/charter.md` | 🧪 Active |
| Saul | Security | `.squad/agents/saul/charter.md` | 🔒 Active |
